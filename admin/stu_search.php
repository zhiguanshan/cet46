...
<html>
	...
	<body background="../img/body_bg.jpg">
		...
		<div class="right">
			...
			<?php
				$sql = "SELECT * FROM student where stu_id='$_POST[CD]'";
				$result = $db->query($sql);
			...
			<table style="margin:40px auto;opacity: 0.8;" border="1px solid" width="1000px" align="center">
				<tr>
					<th width="25%" height="25px" align="center">学号</th>
					<th width="25%" height="25px" align="center">姓名</th>
					<th width="25%" height="25px" align="center">年龄</th>
					<th width="25%" height="25px" align="center">性别</th>
				</tr>
			<?php 
